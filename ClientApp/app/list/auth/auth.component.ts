...
export class authComponent implements OnInit, AfterViewInit {
    ...
    public obj_remove: auth;
    
    public obj_edit: auth;
    public obj_search: auth;
    public list_data: Array<auth> = [];
    @ViewChild('modalForm')
    form1: NgForm;
    @ViewChild('modal1')
    ...
    constructor(private dataService: authService, @Inject(DOCUMENT) private _document: any, private toastyService: ToastyService, private toastyConfig: ToastyConfig) {
        this._document.title = 'Danh sách Công việc/chuyên khoa';
        this.toastyConfig.theme = 'material';
    }
    public ngOnInit() {
        this.obj_remove = new auth();
        this.obj_edit = new auth();
        this.obj_search = new auth();
        this.loadList();
    }
    ngAfterViewInit() {
    }
    ...
    public deleteRow(item: auth): void {
