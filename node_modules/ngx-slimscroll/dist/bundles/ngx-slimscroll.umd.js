(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/Observable'), require('rxjs/Subscription'), require('rxjs/add/observable/fromEvent'), require('rxjs/add/observable/merge'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/takeUntil'), require('rxjs/add/operator/map')) :
	typeof define === 'function' && define.amd ? define('ngx-slimscroll', ['exports', '@angular/core', '@angular/common', 'rxjs/Observable', 'rxjs/Subscription', 'rxjs/add/observable/fromEvent', 'rxjs/add/observable/merge', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/takeUntil', 'rxjs/add/operator/map'], factory) :
	(factory((global['ngx-slimscroll'] = {}),global.ng.core,global.ng.common,global.Rx,global.Rx));
}(this, (function (exports,core,common,Observable,Subscription) { 'use strict';
...
var SlimScrollDirective = /** @class */ (function () {
    function SlimScrollDirective(viewContainer, renderer, document, optionsDefaults) {
        ...
        this.initWheel = function () {
            var dommousescroll = Observable.Observable.fromEvent(_this.el, 'DOMMouseScroll');
            var mousewheel = Observable.Observable.fromEvent(_this.el, 'mousewheel');
            var wheelSubscription = Observable.Observable.merge.apply(Observable.Observable, __spread([dommousescroll, mousewheel])).subscribe(function (e) {
                var delta = 0;
                if (e.wheelDelta) {
        ...
        this.initDrag = function () {
            var bar = _this.bar;
            var mousemove = Observable.Observable.fromEvent(_this.document.documentElement, 'mousemove');
            var touchmove = Observable.Observable.fromEvent(_this.document.documentElement, 'touchmove');
            var mousedown = Observable.Observable.fromEvent(bar, 'mousedown');
            var touchstart = Observable.Observable.fromEvent(_this.el, 'touchstart');
            var mouseup = Observable.Observable.fromEvent(_this.document.documentElement, 'mouseup');
            var touchend = Observable.Observable.fromEvent(_this.document.documentElement, 'touchend');
            ...
            var dragSubscription = Observable.Observable.merge.apply(Observable.Observable, __spread([mousedrag, touchdrag])).subscribe(function (top) {
            ...
            var dragEndSubscription = Observable.Observable.merge.apply(Observable.Observable, __spread([mouseup, touchend])).subscribe(function () {
...
exports.ɵa = SlimScrollDirective;
